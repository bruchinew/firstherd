<template>
    <nav class="bg-gray-200/90 sticky group top-0 w-full left-0 blur-none">
        <div class="flex items-center justify-center">
            <ul
                class="flex text-xs justify-evenly mr-56 content-center items-center justify-items-center w-full"
            >
                <li
                ...
                <img src="/images/wording.png" class="h-8" />
    ...
    <!-- <div class="flex items-center bg-gray-100 justify-between px-32">
        <img src="/images/logo.png" class="h-32" />
        <img src="/images/wording.png" class="h-32" />
    </div> -->
    <p id="subheading" class="text-lg flex text-center px-32 py-3">
        ...
        tailored to your needs, including home and commercial coverages. With
        decades of experience and personal, expert service, we ensure the best
